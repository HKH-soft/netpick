                ...
                <div className="flex items-start">
                    ...
                    <div className="ml-4 flex shrink-0">
                        <button
                            ...
                            className="inline-flex rounded-md bg-white text-zinc-400 hover:text-zinc-500 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:outline-hidden"
                        >
